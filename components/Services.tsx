...
const services = [
  {
    ...
    desc: "Penthouses, villas, country estates. Lighting that responds to ritual — morning meditation through late-night reading.",
    tags: ["Master suites", "Galleries", "Spa & wellness", "Wine cellars"],
  },
  {
    n: "02",
    title: "Hospitality",
    desc: "Boutique hotels and members' clubs where light is the first thing a guest feels and the last thing they remember.",
    tags: ["Lobbies", "Suites", "Restaurants", "Spas"],
  },
  {
    n: "03",
    title: "Yachts & Aviation",
    desc: "Engineered for motion, dimmed for rest, scaled for intimacy. Spec-grade marine and cabin systems.",
    tags: ["Owners' suites", "Sky lounges", "Galleys", "Decks"],
  },
  {
    n: "04",
    title: "Corporate Flagship",
    desc: "Boardrooms, lobbies, and brand experiences. Light that signals the company's posture before a word is spoken.",
    tags: ["Lobbies", "Boardrooms", "Galleries", "Façades"],
  },
  {
    n: "05",
    title: "Heritage & Galleries",
    desc: "UV-managed, conservation-grade illumination for fine art, sculpture, and historic interiors.",
    tags: ["Museum-grade", "Tunable white", "Façade", "Conservation"],
  },
  {
    n: "06",
    title: "Smart Control",
    desc: "Lutron HomeWorks, Crestron, KNX. Scenes choreographed to time of day, occupancy, and circadian rhythm.",
    tags: ["Lutron", "Crestron", "Circadian", "Voice"],
  },
];
        ...
        <div className="flex items-end justify-between mb-20 flex-wrap gap-8">
          <div>
            ...
            <h2 className="font-display font-extralight text-[clamp(2rem,5vw,4.5rem)] leading-[1.05] max-w-3xl">
              ...
              <span className="block italic text-white/60">One singular language of light.</span>
            </h2>
          </div>
        </div>
