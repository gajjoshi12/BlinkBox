...
export default function Philosophy() {
  ...
  const lines = [
    "Light is not a feature.",
    "It is the medium through which",
    "every other material is read.",
  ];
    ...
    >
      <div className="relative z-10 mx-auto max-w-[1400px] w-full grid md:grid-cols-12 gap-12 items-center">
        ...
        >
          ...
          >
            Architecture defines geometry. Materials define texture. But it is light
            — its temperature, its angle, its rhythm — that defines whether a room
            invites you to whisper or to celebrate.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="text-sm text-white/55 leading-relaxed"
          >
            For two decades we have shaped that whisper for the world's most
            private interiors.
          </motion.p>
          <motion.div
            initial={{ scaleX: 0 }}
          ...
          <div className="grid grid-cols-3 gap-4 pt-4">
            {[
              { n: 120, suffix: "+", l: "Residences" },
              { n: 27, suffix: "", l: "Countries" },
              { n: 20, suffix: "yr", l: "Practice" },
            ].map((s, i) => (
              <motion.div
                key={s.l}
                initial={{ opacity: 0, y: 20 }}
