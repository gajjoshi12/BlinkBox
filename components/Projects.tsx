...
const projects = [
  {
    ...
    year: "2024",
    desc: "A 1,200 m² riad reimagined. Lantern-lit courtyards, hand-perforated brass sconces, and a circadian system tuned to the call to prayer.",
  },
  {
    n: "02",
    title: "The Hawthorne",
    ...
    location: "London, UK",
    year: "2024",
    desc: "A 38-key boutique hotel in Mayfair. 412 individually addressable fixtures across 6 floors, each scene painted by hand.",
  },
  {
    n: "03",
    title: "Atelier Onyx",
    type: "Corporate Flagship",
    location: "Dubai, UAE",
    year: "2023",
    desc: "A diamond house's private viewing salons. Museum-grade tunable spots reveal stones at their truest body color.",
  },
  {
    n: "04",
    title: "M/Y Solstice",
    ...
    location: "Monaco",
    year: "2023",
    desc: "92m superyacht. A circadian programme that follows the sun across thirteen time zones, choreographed cabin-by-cabin.",
  },
];
      ...
      <div className={`md:col-span-7 [direction:ltr]`}>
        ...
        >
          ...
          >
            ...
            {/* Floor reflection */}
            <ellipse cx="400" cy="540" rx="350" ry="15" fill="rgba(212,162,74,0.12)" />
      ...
      <div className="relative z-10 mx-auto max-w-[1400px]">
        <div className="mb-24">
          ...
          <h2 className="font-display font-extralight text-[clamp(2rem,5vw,4.5rem)] leading-[1.05] max-w-3xl">
            <span className="block">A discreet portfolio.</span>
            <span className="block italic text-white/60">By invitation, by introduction.</span>
          </h2>
        </div>
