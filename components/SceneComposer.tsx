...
const presets: { name: string; desc: string; on: Fixture[]; k: number }[] = [
  {
    name: "Late Dinner",
    desc: "Chandelier dimmed, sconces warm, fire breathing.",
    on: ["chandelier", "sconces", "fireplace"],
    k: 2200,
  },
  {
    name: "Quiet Reading",
    desc: "A single floor lamp. Everything else hushed.",
    on: ["floor", "fireplace"],
    k: 2700,
  },
  {
    name: "Morning Routine",
    desc: "Cove wash, table lamp on. Daylight on the horizon.",
    on: ["cove", "table"],
    k: 5000,
  },
  {
    name: "Full Reception",
    desc: "Every fixture composed for entertaining.",
      ...
      <div className="relative z-10 mx-auto max-w-[1400px]">
        <div className="mb-16">
          ...
          <h2 className="font-display font-extralight text-[clamp(2rem,5vw,4.5rem)] leading-[1.05] max-w-3xl">
            <span className="block">Compose your own scene.</span>
            <span className="block italic text-white/60">Toggle, dim, and feel the room shift.</span>
          </h2>
        </div>
